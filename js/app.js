(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) {
            ...
            new swiper_core_Swiper(".results__slider", {
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        var purchaseButtons = document.querySelectorAll(".btn-pay");
        if (purchaseButtons.length > 0) purchaseButtons.forEach((function(button) {
